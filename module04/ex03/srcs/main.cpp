...
int main() {
    ...
    {
        std::cout << "1. Create new MateriaSource and learn materias (check "
                     "maximum too):"
                  << std::endl;
        IMateriaSource* src = new MateriaSource();
        src->learnMateria(new Ice());
        ...
        std::cout << "2. Create 2 new characters and test deep copy:"
                  << std::endl;
        ...
        std::cout << "3. Create materias and equip them (also check unknown "
                     "materias):"
                  << std::endl;
        AMateria*   tmp;
        ...
        dur2->equip(ice);
        dur2->unequip(2);
        delete ice;  // Cure must be deleted manually when unequipped
        dur2->unequip(2);
        dur2->unequip(6);
        std::cout << std::endl;
